...
# -*- coding: utf-8 -*-
#
# srs documentation build configuration file, created by
# sphinx-quickstart on Fri Sep 21 22:36:40 2012.
#
...
latex_documents = [
  ('index', 'srs.tex', 'libreQA: SRS Document',
...
man_pages = [
    ('index', 'srs', 'srs Documentation',
     ['Shiv Shankar Dayal & Paan Sharma'], 1)
]
...
texinfo_documents = [
  ('index', 'srs', 'srs Documentation',
   'Shiv Shankar Dayal & Paan Sharma', 'srs', 'One line description of project.',
   'Miscellaneous'),
]
