...
# -*- coding: utf-8 -*-
#
# Low Level Design documentation build configuration file, created by
# sphinx-quickstart on Sun Sep 23 00:12:49 2012.
#
...
copyright = '2012, Shiv Shankar Dayal & Pavan Sharma'
...
htmlhelp_basename = 'LowLevelDesigndoc'
...
latex_documents = [
  ('index', 'LowLevelDesign.tex', 'Low Level Design Documentation',
   'Shiv Shankar Dayal \\& Pavan Sharma', 'manual'),
]
...
man_pages = [
    ('index', 'lowleveldesign', 'Low Level Design Documentation',
     ['Shiv Shankar Dayal & Pavan Sharma'], 1)
]
...
texinfo_documents = [
  ('index', 'LowLevelDesign', 'Low Level Design Documentation',
   'Shiv Shankar Dayal & Pavan Sharma', 'LowLevelDesign', 'One line description of project.',
   'Miscellaneous'),
]
